...
<div style="background-color: #f5f7f8; padding: 30px; border-radius: 15px; width: 100%;">
  <div style="background-color: #ffffff; padding: 30px; border-radius: 12px; border-left: 10px solid #455a64; box-shadow: 0 4px 15px rgba(0,0,0,0.05);border: 2px solid #455a64";>
