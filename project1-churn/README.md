...
<h2 style="color: #455a64; padding-left: 10px; border-bottom: none; background: linear-gradient(to right, rgba(112, 128, 144, 0.05) 0%, rgba(112, 128, 144, 0.25) 100%);">Exposing the Underlying Drivers ❓</h2>
