...
<div style="display: flex; gap: 15px; justify-content: space-between;">
  <a href="https://nbviewer.org/github/DungNguyen396/DungNguyen-portfolio/blob/main/project1-churn/eda.ipynb" style="flex: 1; text-decoration: none;">
    <div style="background-color: #f0f7ff; border: 1px solid #1a3a5f; border-radius: 10px; padding: 15px; text-align: center; height: 100%; box-shadow: 0 4px 6px rgba(0,0,0,0.05);">
  ...
  <a href="./query.md" style="flex: 1; text-decoration: none;">
    <div style="background-color: #f4faff; border: 1px solid #4682B4; border-radius: 10px; padding: 15px; text-align: center; height: 100%; box-shadow: 0 4px 6px rgba(0,0,0,0.05);">
      <div style="font-size: 24px; margin-bottom: 8px;">⚡</div>
  ...
  <a href="https://nbviewer.org/github/DungNguyen396/DungNguyen-portfolio/blob/main/project1-churn/explain.ipynb" style="flex: 1; text-decoration: none;">
    <div style="background-color: #f8f9fa; border: 1px solid #708090; border-radius: 10px; padding: 15px; text-align: center; height: 100%; box-shadow: 0 4px 6px rgba(0,0,0,0.05);">
      <div style="font-size: 24px; margin-bottom: 8px;">📊</div>
