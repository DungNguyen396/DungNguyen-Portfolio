<div align="center">
  ...
  <div style="margin-bottom: 20px;">
    ...
    <img src="https://img.shields.io/badge/Tools-Python%20%26%20Scikit--Learn-1a3a5f?style=for-the-badge" />
  </div>
</div>

<br>

<div style="background-color: #f4f6f7; padding: 30px; border-radius: 15px; width: 100%;">
...
<div style="width: 100%; display: flex; flex-direction: column; gap: 20px;">
  ...
  <div style="display: flex; align-items: center; background: #ffffff; padding: 20px; border-radius: 12px; border: 1px solid #dee2e6; box-shadow: 0 8px 15px rgba(26, 58, 95, 0.1); position: relative; overflow: hidden;">
    ...
    <div style="flex: 1; z-index: 1;">
      <h4 style="color: #1a3a5f; margin: 0; font-size: 16px; text-transform: uppercase;">Model Reliability</h4>
      <p style="color: #444; margin: 5px 0 0 0; font-size: 15px;">How accurately does the model’s predicted loss probability align with actual historical outcomes?</p>
    </div>
    <div style="color: #ebedef; font-size: 55px; font-weight: 900; position: absolute; right: 10px; bottom: -12px; z-index: 0;">02</div>
  </div>
  <div style="display: flex; align-items: center; background: #ffffff; padding: 20px; border-radius: 12px; border: 1px solid #dee2e6; box-shadow: 0 8px 15px rgba(26, 58, 95, 0.12); position: relative; overflow: hidden;">
    <div style="font-size: 30px; margin-right: 20px;">⚡</div>
    <div style="flex: 1; z-index: 1;">
      <h4 style="color: #1a3a5f; margin: 0; font-size: 16px; text-transform: uppercase;">Operational Efficiency</h4>
    ...
    <div style="color: #d6dbdf; font-size: 55px; font-weight: 900; position: absolute; right: 10px; bottom: -12px; z-index: 0;">03</div>
  </div>
</div>
...
<div style="background-color: #f4f6f7; padding: 30px; border-radius: 15px; width: 100%;">
  ...
  <div style="background-color: #ffffff; padding: 18px; border-radius: 10px; border-left: 10px solid #5d6d7e; margin-bottom: 20px; box-shadow: 0 8px 20px rgba(93, 109, 126, 0.15);">
    <b style="color: #1a3a5f; font-size: 16px;">1. Optimal Threshold Identification (0.88)</b>
  ...
  <div style="background-color: #ffffff; padding: 18px; border-radius: 10px; border-left: 10px solid #34495e; margin-bottom: 20px; box-shadow: 0 8px 20px rgba(52, 73, 94, 0.2);">
    <b style="color: #1a3a5f; font-size: 16px;">2. High-Fidelity Calibration (Brier Score: 0.11)</b>
    <p style="margin-top: 5px; color: #2c3e50;">Confirmed that the model’s risk assessments are highly reliable and align closely with actual outcomes.</p>
  </div>
  <div style="background-color: #ffffff; padding: 18px; border-radius: 10px; border-left: 10px solid #2c3e50; margin-bottom: 20px; box-shadow: 0 8px 20px rgba(44, 62, 80, 0.25);">
    <b style="color: #1a3a5f; font-size: 16px;">3. 92% Workflow Automation Rate</b>
  ...
  <div style="background-color: #ffffff; padding: 18px; border-radius: 10px; border-left: 10px solid #1a3a5f; box-shadow: 0 8px 25px rgba(26, 58, 95, 0.3);">
    <b style="color: #1a3a5f; font-size: 16px;">4. Measurable Profit Lift</b>
